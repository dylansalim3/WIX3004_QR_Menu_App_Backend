...
const { GET_FAV_LIST, GET_RECENTLY_VIEWED_LIST, ADD_TO_FAV, REMOVE_FAV, ADD_TO_RECENTLY_VIEWED, CHECK_IS_FAV } = require('./../constant/route-constant');
...
favorite.post(CHECK_IS_FAV, FavoriteController.checkIsFavorite);
